...
multiAns1 = [
    ...
    "Caring for and cleaning our bodies<br> to promote good health and happiness",
    "Ice cubes in a tray",
    "Attacks",
...
multiAns3 = [
    "Is a collection of habits people perform<br>to keep themselves<br> clean and their bodies healthy",
    "Not alive",
...
multiAns4 = [
    "Increases the number of<br> germs that enter our bodies",
...
questions = [
    "(fill in the blank) Personal hygiene___",
